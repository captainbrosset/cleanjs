...
class Reviewer(BaseReviewer):
	...
	def review_comments_after_statements(self, lines, message_bag):
		for line_index, content in enumerate(lines):
			...
			if comments:
				message_bag.add_warning(self, "Line " + str(line_index+1) + " has comments after a statement or assignment. This is usually a sign that you need to explain a complex piece of code.")
